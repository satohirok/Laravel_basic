                ...
                @foreach ($blogs as $blog)
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            <img class="w-12 h-12 mr-4 object-cover rounded-md" src="storage/{{ $blog->image }}" alt="">
                            <p class="font-medium"><a href="{{ route('admin.blogs.edit', ['id' => $blog->id]) }}">{{ $blog->title }}</a></p>
                        </td>
                        ...
                        <td>
                            <div class="flex">
                                <a class="mr-2" href="{{ route('admin.blogs.edit', ['id' => $blog->id]) }}">
